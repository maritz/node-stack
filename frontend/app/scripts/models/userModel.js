define(["nohmValidations", "libs/backbone/model", "utility/forms"], function (nohmValidations, baseModel, forms) {
  var exports = {};
  var app = window.app;
  ...
  exports.User = baseModel.model.extend({
    urlRoot: '/REST/User/',
    nohmName: 'User',
    
    initialize: function () {
      this.pw_repeat_set_once = false;
      baseModel.model.prototype.initialize.call(this);
    },
  ...
  var Self = baseModel.model.extend({
    ...
    load: function () {
      ...
      $.getJSON('/REST/User/loginData')
        .success(function (result) {
          ...
          self.loaded = true;
          window.app.trigger('user_loaded', true);
        })
        .error(function (jqXHR) {
          jqXHR.handled = true;
          self.loaded = true;
          window.app.trigger('user_loaded', false);
        });
    },
