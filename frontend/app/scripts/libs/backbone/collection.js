define(["underscore", "backbone"], function (_, Backbone) {
   ...
   */
  exports.paginatedCollection = exports.collection.extend({  
    ...
    reset: function (models, options) {
      ...
      return exports.collection.prototype.reset.call(this, models, options);
    },
    ...
    fetch: function (options) {
      ...
      return exports.collection.prototype.fetch.call(this, options);
    },
    ...
    getLoadedPage: function (offset) {
      ...
      var collection = new exports.collection();
