define(["backbone", "underscore", "utility/forms"], function (Backbone, _, forms) {
  var exports = {};
  var app = window.app;
  
  _.extend(Backbone.View.prototype, Backbone.Events);
  
  exports.pageView = Backbone.View.extend({
    ...
    initialize: function () {
      ...
      this.$el = this.options.$el || this.$el || window.app.config.$content;
      this.el = this.$el[0];
      this.module = this.options.module || this.module;
      this.action = this.options.action || this.action;
      this.i18n = [this.module, this.action];
      this.rendered = false;
      this.params = Array.isArray(this.options.params) ? this.options.params : [];
      ...
      if (this.reload_on_login) {
        window.app.once('login', function () {
    ...
    successRender: function (locals) {
      var self = this;
      window.app.template(this.module, this.action, locals, function (html) {
        if (html === false) {
    ...
    errorRender: function (locals) {
      ...
      window.app.template(module, action, locals, function (html) {
    ...
    closeAndBack: function () {
      ...
      if (this.$el.parent()[0] === window.app.config.$content[0]) {
        window.app.back();
      }
    },
  ...
  exports.formView = exports.pageView.extend({
    
    initialize: function () {
      if ( ! exports.pageView.prototype.initialize.apply(this, arguments)) {
        return false;
      }
    },
     ...
     */
    afterRender: function (html) {
      exports.pageView.prototype.afterRender.call(this, html);
      this.handler = new forms.formHandler(this);
      this.handler.link();
  ...
  exports.listView = exports.pageView.extend({
    ...
    initialize: function () {
      ...
      return exports.pageView.prototype.initialize.apply(this, arguments);
    },
    ...
    _unload: function () {
      ...
      exports.pageView.prototype._unload.apply(this, arguments);
    },
  ...
  exports.paginatedListView = exports.listView.extend({
    ...
    initialize: function () {
      ...
      if ( ! exports.listView.prototype.initialize.apply(this, arguments)) {
        return false;
      }
    ...
    renderPagination: function () {
      ...
      window.app.template('page', 'pagination', locals, function (html) {
