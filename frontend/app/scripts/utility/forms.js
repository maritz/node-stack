define(["jquery", "underscore", "jquery.cookie"], function ($, _) {
  ...
  var getCsrf = exports.getCsrf = getCsrf = function (callback) {
  ...
  var formHandler = exports.formHandler = function (view, model) {
    this.view = view;
  ...
  formHandler.prototype.link = function () {
    ...
    this.model.bind("error", function(model, error) {
      if (error.getAllResponseHeaders) {
        return false; // in backbone 0.9 we get error events on the model on xhr errors as well.
      }
